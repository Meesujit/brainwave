            ...
            <div className="relative">
                <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
                    <div className="absolute top-0 left-0 w-full h-full pointer-events-none md:w-3/5 xl:w-auto">
                        <img src={service1} alt="smartest AI" className='w-full h-full object-cover object-right ' width={800} height={730} />
                    </div>
                    ...
                    <div className=" p-4 bg-n-7 overflow-hidden lg:min-h-[46rem]">
                        <div className="py-12 px-4 xl:px-8 ">
                            ...
                            <p className="body-2 mb-[2rem] text-n-3">
                                The world&apos; most powerful AI photo and video art generation engine. What you will create?
                            </p>
                        ...
                        <div className=" relative h-[20rem] bg-n-8 rounded-xl overflow-hidden md:h-[25rem] ">
                           <img src={service3} className='w-full h-full object-cover' alt="Cool robot" width={520} height={400} />    
                           <VideoChatMessage />
                           <VideoBar />     
                        </div>
                    </div>
